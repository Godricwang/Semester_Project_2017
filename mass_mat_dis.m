function mass_ = mass_mat_dis(in1)
...
mass_ = [Il1 + ml1 * l1^2 + k^2 * Im1 + Il2 + ml2 * (a1^2 + l2^2 + 2 * a1 * l2 * cos(thet2)) + Im2 + mm2 * a1^2, Il2 + ml2 * (l2^2 + a1 * l2 * cos(thet2));
         Il2 + ml2 * (l2^2 + a1 * l2 * cos(thet2)), Il2 + ml2 * l2^2 + k^2 * Im2];
